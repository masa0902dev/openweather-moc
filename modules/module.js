...
target_urls_all = readAllLineCSV(read_file_path, skip_row); //[ [5,26,5110,23100,Aichi,51,名古屋], [3,16,4410,13104,Tokyo,44,東京],  ...]
...
// string, int -> array
function readAllLineAnyOneColCSV(file_path, skip_row = 0) {
...
// string, array -> void
appendCSV = function(file_path, record) {
...
module.exports = {
  ...
  skip_row: skip_row,
  target_urls_all: target_urls_all,

  apiURL: apiURL,
  getAPI: getAPI,

  readAllLineCSV: readAllLineCSV,
  readAllLineOneColCSV: readAllLineOneColCSV,
  readAllLineAnyOneColCSV: readAllLineAnyOneColCSV,
  ...
  rmAllLastLineCSV: rmAllLastLineCSV,
  rmLastLineCSV: rmLastLineCSV
}
